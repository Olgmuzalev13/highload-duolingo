...
### Алгоритм для оптимизации повторяющихся уведомлений
...
Для каждого формата указывается машинно-обученную модель шкалы, используемую для прогнозирования сложности элемента , языковые навыки, которые она, как известно, предсказывает (L = аудирование, R  чтение, S = говорение, W = письмо).
...
Для ранжирования отрывков по сложности используется линейный подход, аналогичный подходу Скалли.  
