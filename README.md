...
DNS балансировка будет производиться между континентами. Выберем тип Latency-based DNS балансировки для этого.

### Схема Anycast балансировки (при наличии)

Anycast балансировка будет в Северной Америке и в Европе.

### Механизм регулировки трафика между ДЦ (при наличии)

Регулировка трафика также будет происходить в Северной Америке и в Европе, на карте обозначены промежуточные зоны пользователи из которых будут направляться
