...
**MongoDB** - будем использовать для большинства таблиц, автоматически хорошо масштабируется, Casandra не нужна так как нет потребности в добавлении произвольного количества столбцов.  
