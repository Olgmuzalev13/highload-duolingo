...
Примем, что из-за малого размытия аудитории по часовым поясам график выглядит примерно так, соответственно пиковое потребление от среднего отличается в 4 раза.
...
Получается общее количество запросов на задания: с произношением - 93M, с правописанием - 124M, с озвучкой - 589M, аудирование - 9,3M. Из этих данных рассчитаем Средний RPS, равномерно распределив запросы в течении дня, а потом посчитаем пиковый рпс из предположения что распредение согласно картинке выше и Максимальный RPS=4*RPS средний. Получаем:

| Действие пользователя              | Средний RPS | Пиковый RPS |
| ---------------------------------- | ------------|------------ |
| Задание на произношение                       |    1076 |    4304 |
| Задание на правописание                       |   1435  |    5740 |
| Задание с озвучкой                       |  6817   |    27268 |
| Задание аудирование                       |  107   |    428 |
